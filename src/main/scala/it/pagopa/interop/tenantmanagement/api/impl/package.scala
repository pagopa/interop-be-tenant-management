...
package object impl extends SprayJsonSupport with DefaultJsonProtocol {
  ...
  implicit val revokerFormat: RootJsonFormat[TenantRevoker]                      = jsonFormat6(TenantRevoker)
  ...
  implicit val mailSeedFormat: RootJsonFormat[MailSeed]                          = jsonFormat2(MailSeed)
  implicit val mailFormat: RootJsonFormat[Mail]                                  = jsonFormat3(Mail)
  implicit val tenantFormat: RootJsonFormat[Tenant]                              = jsonFormat8(Tenant)
